[![Build status](https://ci.appveyor.com/api/projects/status/uqlocuc0yqbgo2an?svg=true)](https://ci.appveyor.com/project/elenakoch122/ra47-9-2-router-crud)

GitHub Pages: https://elenakoch122.github.io/ra47_9.2-router-crud
